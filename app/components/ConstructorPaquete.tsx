      ...
      {opciones.hospedaje === 'Camping' && (
        <div className="space-y-3 animate-in fade-in">
          <div className="bg-[#0a0a0a] border border-emerald-500/20 rounded-xl p-4 space-y-3">
            ...
            {[{ val: 'propio', label: '✅ Equipo Propio', desc: `$${finanzas?.camping || 120} por casa de campaña` }, { val: 'renta', label: '🏕️ Rentar Casa de Campaña', desc: `$${finanzas?.camping || 120} + $${finanzas?.camping_renta_extra || 100} extra por casa de campaña` }].map(op => (
